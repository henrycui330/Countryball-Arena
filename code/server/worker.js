...
export class RoomServer {
  ...
  async webSocketMessage(ws, raw) {
    ...
    if (type === "set_loadout") {
      if (payload.fighter === "usa" || payload.fighter === "japan" || payload.fighter === "russia" || payload.fighter === "france" || payload.fighter === "uk" || payload.fighter === "china" || payload.fighter === "canada") {
